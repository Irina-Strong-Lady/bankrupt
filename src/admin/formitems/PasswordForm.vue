...
const eyesChange = () => eyes.value = !eyes.value

const { width } = useWindowSize()

const size = ref(null)

const eyeSize = () => width.value > 1200 ? size.value = 30 : size.value = 20;
...
<template>
  <el-form-item>
    ...
    <div @click="eyesChange" class="fa-eye">
      ...
      <svg v-if="eyes" xmlns="http://www.w3.org/2000/svg" :width="eyeSize()" :height="eyeSize()" fill="#FFFFFF" class="bi bi-eye" viewBox="0 0 16 16"> 
